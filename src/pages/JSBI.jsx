...
const JSBI = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* CTA Section */}
      <section className="py-12 bg-[#404040]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-orange-600 text-white px-5 py-2.5 rounded-none font-bold text-sm hover:bg-orange-700 transition shadow-lg hover:shadow-orange-500/20">
                Apply Now
              </button>
              <button className="bg-transparent border-2 border-white text-white px-5 py-2.5 rounded-none font-bold text-sm hover:bg-white hover:text-gray-900 transition">
                Schedule a Visit
              </button>
            </div>
          </motion.div>
